...
// 	"ЗАказать Курс на ПРАВИльное ОБРАЗование с рАЗкрытием и монетизацией талантов",
// ];
...
$main_buttons = [
	...
	"поЛУЧить 10 ЭКП 🏡Дом Кипрея 🌿",
	"КОНсультация от КЦР АЗ КОНсультантЫ",
	"КОНсультация от Клуба Здравия ☀️РОД☀️",
	"ЗАявление в ПАйщики 🏡Дом Кипрея 🌿",
	"ЗАявка на 👨‍👩‍👧‍👦Семейный Тур",
	"ЗАявка на переезд в ЭКОпоселение",
	"Курс на ПРАВИльное ОБРАЗование",
];
