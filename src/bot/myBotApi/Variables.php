...
$MainKeyboardMarkup = [
	'keyboard' => [
		[
			[
				'text' => "ЗАказать приРОДныеПРОДУКТЫ.рус",
			],
		],
		[
			[
				'text' => "ЗАказать Энергоэффективный Дом на своей земле за ЯРГА токен через ЯРГАтокен.рус",
			],
		],
		[
			[
				'text' => "поЛУЧить ДАРы 10 ЭКП 🏡Дом Кипрея 🌿 на 1 ЧелАвека от КБ АРТель Строителей 🏡🌲🌿🌊☀️ Тихо в Лесу☀️🌊🌿🌲🌳",
			],
		],
		[
			[
				'text' => "ЗАказать КОНсультацию от КЦР АЗ КОНсультантЫ",
			],
		],
		[
			[
				'text' => "ЗАказать КОНсультацию от Кооперативного Клуба Здравия ☀️РОД🌳",
			],
		],
		[
			[
				'text' => "ЗАваять✍️ ЗАявление в ПАйщики приРОДного Потреб Кооператива 🏡Дом Кипрея 🌿",
			],
		],
		[
			[
				'text' => "Оформить✍️ ЗАявку на 👨‍👩‍👧‍👦Семейный Тур🚟 на🌊 🌊Байкал🌊🌿🌊🌲🏡🌳 от РУСьТурЭко",
			],
		],
		[
			[
				'text' => "Оформить ЗАявку на переезд в РОДовое Поселение или ЭКОпоселение",
			],
		],
		[
			[
				'text' => "взять с сайта ДомКипрея.рус про рАЗкрытие талантов",
			],
		],
	],
	'resize_keyboard' => false,
